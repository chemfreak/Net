...
from MyNet.layers import ConvLayer
from MyNet.layers import ActivationLayer
...
# network
net = Network()
net.add(ConvLayer((10,10,1), 3, 1))
net.add(ActivationLayer(tanh, tanh_prime))
net.add(ConvLayer((8,8,1), 3, 1))
net.add(ActivationLayer(tanh, tanh_prime))
net.add(ConvLayer((6,6,1), 3, 2))
net.add(ActivationLayer(tanh, tanh_prime))
